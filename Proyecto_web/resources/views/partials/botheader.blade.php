<nav class="navbar navbar-expand-lg bg-body-tertiary custom-navbar">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="/products/index">Vender</a>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#compu_section">Computadores</a></li>
                            <li><a class="dropdown-item" href="#cellphone_section">Celulares</a></li>
                            <li><a class="dropdown-item" href="#gadgets_section">Gatgets</a></li>
                        </ul>
                    </div>
